...
from envs.base import Env, Step
...
class GymEnv(Env, Serializable):
    ...
    def reset(self, state=None):
        # TODO add reset state functionality
    ...
    @property
    def state(self):
        # TODO untested. Must be named obs not state!! env.state_vector() gives state.
